...
public class ItemCreativeCapacitor extends Item {
        ...
        ICapabilityProvider capProvider = new ICapabilityProvider() {
            ...
            public <T> T getCapability(@Nonnull Capability<T> capability, @Nullable EnumFacing facing) {
                if (capability == CapabilityCapacitorData.getCapNN()) {
                    return CapabilityCapacitorData.getCapNN().cast(CreativeCapacitorData.instance);
                }
                return null;
            }
        };
    ...
    public void addInformation(@Nonnull ItemStack stack, @Nullable World worldIn, @Nonnull List<String> tooltip, @Nonnull ITooltipFlag flagIn) {
        ...
        tooltip.add("Global Level: " + TextFormatting.GOLD + TextFormatting.BOLD + CreativeCapacitorData.globalLevel);
    }
}
